# Identidad visual — Victoria en Cristo

## Idea central

La marca parte de una **Biblia abierta** cuyas páginas forman la **V** de
Victoria. El vértice funciona como camino: nace en la Palabra, asciende y
orienta la mirada hacia la **cruz**. El símbolo comunica que la victoria no es
un destino abstracto, sino una dirección que se recorre.
...
- La versión detallada se usa en tiendas, la app y el hero de la web.
- La versión reducida conserva Biblia, V y cruz para favicon, navegación y
  tamaños donde los rayos o las líneas de las páginas dejan de ser legibles.
