 ...
 */
async function deleteSubcollection(userDocRef, subcollectionName) {
    ...
    try {
        ...
        for (const subcollection of USER_SUBCOLLECTIONS) {
            try {
                ...
                console.warn(`⚠️ [DELETE] Error deleting ${subcollection}:`, err);
        ...
        throw new functions.https.HttpsError("internal", "Error al eliminar la cuenta. Por favor, contacta soporte.", { error: String(error) });
    }
});
