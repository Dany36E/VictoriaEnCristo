...
class ProfileRepository {
  ...
  Future<UserProfile?> _doConnectUser(String uid) async {
    ...
    try {
      ...
      // CRÍTICO: Siempre descartar cache local antes de conectar.
  ...
  Future<bool> completeOnboarding({
    ...
    return updateProfile((profile) => profile.copyWith(
  ...
  Future<void> migrateFromLegacyOnboarding(SharedPreferences prefs) async {
    try {
      ...
      await updateProfile((profile) => profile.copyWith(
