...
class BibleSettingsScreen extends StatelessWidget {
  ...
  Future<void> _selectPreferredVersion(
              ...
              return Column(
                children: BibleVersion.values.map((v) {
                  ...
                  return GestureDetector(
                    onTap: () => _selectPreferredVersion(context, v),
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: selected
                            ? Border.all(color: t.accent.withOpacity(0.3))
                            : null,
                      ),
                      child: Row(
                        children: [
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.menu_book_outlined, color: t.accent, size: 22),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      children: [
                        ...
                        if (isDownloadingThis)
                          ...
                          IconButton(
                            ...
                            onPressed: () async {
                              final ok = await dl.downloadVersion(version);
